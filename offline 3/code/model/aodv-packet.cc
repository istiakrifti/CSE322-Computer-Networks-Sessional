...
RrepHeader::Print(std::ostream& os) const
{
    ...
    os << " source ipv4 " << m_origin << " lifetime " << m_lifeTime << " congestion flag " << m_congesFlag
...
RrepHeader::operator==(const RrepHeader& o) const
{
    return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize && m_hopCount == o.m_hopCount &&
            ...
            m_lifeTime == o.m_lifeTime && m_congesFlag == o.m_congesFlag);
}
...
void 
RrepHeader::SetCongestionFlag(int32_t congesFlag)
{
    m_congesFlag = congesFlag;
}
