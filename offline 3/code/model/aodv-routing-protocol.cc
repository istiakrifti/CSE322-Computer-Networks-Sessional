...
RoutingProtocol::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::aodv::RoutingProtocol")
            ...
            .AddAttribute("m_congesCounter", "m_congesCounter.", UintegerValue(0), MakeUintegerAccessor(& RoutingProtocol::m_congesCounter), MakeUintegerChecker<uint32_t>());
    return tid;
}
...
RoutingProtocol::RecvRequest(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src)
{
    ...
    if(m_congesCounter > MAX_CONGESTION_COUNT)
    {
        NS_LOG_DEBUG("Ignoring RREQ");
        return;
    }
